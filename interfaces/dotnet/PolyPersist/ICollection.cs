...
namespace PolyPersist
{
		...
		where TEntity: IEntity
	{
		...
		Task<IResult> InsertOne( TEntity entity );
		...
		Task<IResult> UpdateOne( TEntity entity );
		/// Asynchronous method to upsert (insert or update) a single entity in the collection.
		/// The 'entity' parameter is of type TEntity, which represents the entity to be upserted.
		///
		/// The entity must have its ID already set for the upsert operation.
		/// If the entity with the specified ID exists in the collection, it will be updated.
		/// If the entity with the specified ID does not exist, it will be inserted as a new entity.
		Task<IResult> UpsertOne( TEntity entity );
		...
		/// If no entity with the specified ID exists, the operation will likely fail.
		Task<IResult> DeleteOne( TEntity entity );
		...
		/// If no entity with the specified ID exists, the operation will likely fail.
		Task<IResult> DeleteOne( string id );
