...
public interface IColumnStore extends IStore {
	...
	<TRow extends IRow> CompletableFuture<IColumnTable<TRow>> GetTableByName(String tableName);
	...
	<TRow extends IRow> CompletableFuture<IColumnTable<TRow>> CreateTable(String tableName);
